...
public class ReduceJoinByDistributedCache extends Configured implements Tool {
            ...
            for (Path path : cacheFilesPaths) {
                ...
                while (null != (infoAddr = br.readLine())) {
                    ...
                    if (null != records) {
                        ...
                        System.out.println("records[0]：" + records[0] + ",records[1]:" + records[1]);
    ...
    public static void main(String[] args) throws Exception {
        String[] args0 = {"hdfs://mini1:9000/record/station.txt"
                , "hdfs://mini1:9000/record/records.txt"
                , "hdfs://mini1:9000/record/dis-out"
        };
        int ec = ToolRunner.run(new Configuration(), new ReduceJoinByDistributedCache(), args0);
        System.exit(ec);
    }
}
